...
module.exports = class Services {
  ...
  static async UsuarioLogin(req, res) {
    ...
    const options = {
      ...
      //----->>>>>> url: "http://localhost:9443/usuarios/login",
      // url: "https://apivarejo.adrianomatos.repl.co/login",
      method: "POST",
      data: valores,
    };
  ...
  static async ProdutoCreate(req, res) {
    ...
    const options = {
      //URL da API
      url: "http://localhost:9443/add_produtos",
      // url: "https://apivarejo.adrianomatos.repl.co/add_produtos",
      method: "POST",
      data: valores,
    };
    axios(options);
  ...
  static async ProdutoListar(req, res) {
    const options = {
      //URL da API
      url: "http://localhost:9443/produtos",
      // url: "https://apivarejo.adrianomatos.repl.co/produtos",
      method: "GET",
      data: {},
    };
